...
use DroidInfotech\DroidBundle\Form\AnswerType;
...
class AnswerController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $answers = $em->getRepository('DroidInfotechDroidBundle:Answer')->findAll();
    ...
    {
        $answer = new Answer();
        $form = $this->createForm('DroidInfotech\DroidBundle\Form\AnswerType', $answer);
    ...
    {
        $deleteForm = $this->createDeleteForm($answer);
        $editForm = $this->createForm('DroidInfotech\DroidBundle\Form\AnswerType', $answer);
