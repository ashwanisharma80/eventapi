...
class appProdDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'pushnotification' => 'getPushnotificationService',
     ...
     * This method always returns the same instance of the service.
     *
     * @return \Bonnier\BonierBundle\Controller\CustomExceptionController A Bonnier\BonierBundle\Controller\CustomExceptionController instance
     */
    protected function getApp_ExceptionControllerService()
    {
        return $this->services['app.exception_controller'] = new \Bonnier\BonierBundle\Controller\CustomExceptionController($this->get('twig'), true);
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => NULL, 'dbname' => 'school@manager', 'user' => 'event_manager', 'password' => 'r&ru0AdgB[#e', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/DroidInfotech/DroidBundle/Entity'))), 'DroidInfotech\\DroidBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('DroidInfotechDroidBundle' => 'DroidInfotech\\DroidBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_64c5174bca6c590dd4d97bc6dd5ce9eb78ed8290c9ce32334d3cb8bcfda86306');
    ...
    /**
     * Gets the 'pushnotification' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Bonnier\BonierBundle\Service\Pushnotification A Bonnier\BonierBundle\Service\Pushnotification instance
     */
    protected function getPushnotificationService()
    {
        return $this->services['pushnotification'] = new \Bonnier\BonierBundle\Service\Pushnotification();
    }
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('DroidInfotech\\DroidBundle\\Entity\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\Pbkdf2PasswordEncoder', 'arguments' => array(0 => 'sha512', 1 => true, 2 => 4096, 3 => 40))));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $b, 1 => $this->get('security.user.provider.concrete.in_memory')), 'main', $c, $d), 2 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '59ede00b317563.87900139', $c, $this->get('security.authentication.manager')), 3 => new \Symfony\Component\Security\Http\Firewall\SwitchUserListener($a, $b, $this->get('security.user_checker.main'), 'main', $this->get('security.access.decision_manager'), $c, '_switch_user', 'ROLE_ALLOWED_TO_SWITCH', $d), 4 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $this->get('security.http_utils'), 'main', NULL, NULL, NULL, $c, false));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_SecuredAreaService()
    {
        ...
        return $this->services['security.firewall.map.context.secured_area'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $this->get('security.user.provider.concrete.user_db'), 1 => $this->get('security.user.provider.concrete.in_memory')), 'secured_area', $b, $c), 2 => $f, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($a, $this->get('security.authentication.manager'), new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate'), $d, 'secured_area', $g, $h, array('check_path' => 'index', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $b, $c, NULL), 4 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $d, 'secured_area', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $d, 'login', false), NULL, NULL, $b, false));
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addGlobal('domain', 'http://droidinfotech.com/web');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/DroidInfotech/DroidBundle/Resources/views'), 'DroidInfotechDroid');
     ...
     * This method always returns the same instance of the service.
     *
     * @return \Bonnier\BonierBundle\Service\Utility A Bonnier\BonierBundle\Service\Utility instance
     */
    protected function getUtilityService()
    {
        return $this->services['utility'] = new \Bonnier\BonierBundle\Service\Utility();
    }
    ...
    protected function getSecurity_AccessMapService()
    {
        ...
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/webservice/*'), array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/user/*'), array(0 => 'ROLE_ADMIN', 1 => 'ROLE_USER'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/events/*'), array(0 => 'ROLE_ADMIN', 1 => 'ROLE_USER'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/category/*'), array(0 => 'ROLE_ADMIN', 1 => 'ROLE_USER'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/exhibitor/*'), array(0 => 'ROLE_ADMIN', 1 => 'ROLE_USER'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/updatepassword/*'), array(0 => 'ROLE_ADMIN', 1 => 'ROLE_USER'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/adduser/*'), array(0 => 'ROLE_ADMIN', 1 => 'ROLE_USER'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/maps/*'), array(0 => 'ROLE_ADMIN', 1 => 'ROLE_USER'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/dashboard/*'), array(0 => 'ROLE_ADMIN', 1 => 'ROLE_USER'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/survey/mobilesurvey'), array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/survey/intro'), array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/survey/attempted'), array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/survey/*'), array(0 => 'ROLE_ADMIN', 1 => 'ROLE_USER'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/notification_message/*'), array(0 => 'ROLE_ADMIN', 1 => 'ROLE_USER'), NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/device/*'), array(0 => 'ROLE_ADMIN', 1 => 'ROLE_USER'), NULL);
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('59ede00b317563.87900139'), 1 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($this->get('security.user.provider.concrete.user_db'), $this->get('security.user_checker.main'), 'secured_area', $this->get('security.encoder_factory'), true)), true);
    ...
    {
        return $this->services['security.user.provider.concrete.user_db'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine'), 'DroidInfotech\\DroidBundle\\Entity\\User', 'email', NULL);
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'DroidInfotechDroidBundle' => 'DroidInfotech\\DroidBundle\\DroidInfotechDroidBundle',
            ),
            'kernel.charset' => 'UTF-8',
            'kernel.container_class' => 'appProdDebugProjectContainer',
            'database_host' => 'localhost',
            'database_port' => NULL,
            'database_name' => 'school@manager',
            'database_user' => 'event_manager',
            'database_password' => 'r&ru0AdgB[#e',
            ...
            'locale' => 'en',
            'event_image_dir' => ($this->targetDirs[3].'/app/../web/uploads/eventimages/'),
            'map_image_dir' => ($this->targetDirs[3].'/app/../web/uploads/mapsimages/'),
            'exhibitor_image_dir' => ($this->targetDirs[3].'/app/../web/uploads/exhibitorimages/'),
            'fromemail' => 'offroadexpo@familyevents.com',
            'allowedext' => array(
                0 => 'png',
                1 => 'PNG',
            ),
            'domain' => 'http://droidinfotech.com',
